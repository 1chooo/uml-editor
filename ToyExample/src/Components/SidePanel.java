...
import test.src.Modes.CreateClassMode;
import test.src.Modes.CreateLineMode;
import test.src.Modes.CreateUseCaseMode;
import test.src.Modes.Mode;
import test.src.Modes.SelectMode;
